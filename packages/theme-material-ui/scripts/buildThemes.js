...
import colorSchemes from "../../theme-data/src/colorSchemes";
import densities from "../../theme-data/src/densities";
import generateAllThemes from "../../theme-data/src/utils/generateAllThemes";

const buildMuiConfigPath = path.join(process.cwd(), "build/mui");
